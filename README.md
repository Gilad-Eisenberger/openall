...
Traditional software requires a translation layer:
...
- A language model acts as the runtime, interpreting and executing your intent in real time  

## License

Copyright (c) 2026 openall contributors

This project is licensed under the PolyForm Noncommercial License 1.0.0.

Commercial use is prohibited without separate permission.
